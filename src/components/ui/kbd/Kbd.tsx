  ...
  ({ children, className }) => {
    ...
    React.useEffect(() => {
      const handler = (event: KeyboardEvent) => {
        setIsKeyPressed(isHotkeyPressed(children.toLowerCase(), event))
      }
...
function MaterialSymbolsKeyboardCommandKey(
...
function MaterialSymbolsKeyboardOptionKey(
  props: React.SVGProps<SVGSVGElement>,
) {
  return (
    <svg
...
function MaterialSymbolsKeyboardControlKey(
  props: React.SVGProps<SVGSVGElement>,
) {
  return (
    <svg
...
function MaterialSymbolsShiftOutlineRounded(
  props: React.SVGProps<SVGSVGElement>,
) {
  return (
    <svg
...
function MaterialSymbolsKeyboardTabRounded(
  props: React.SVGProps<SVGSVGElement>,
) {
  return (
    <svg
...
function MaterialSymbolsWindowOutlineSharp(
  props: React.SVGProps<SVGSVGElement>,
) {
  return (
    <svg
...
function isHotkeyPressed(key: string, event: KeyboardEvent): boolean {
